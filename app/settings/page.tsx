        ...
        <div style={{display:'flex',flexDirection:'column',gap:'1.5rem'}}>
          ...
          <div style={{border:'1px solid var(--border)',borderRadius:4,overflow:'hidden'}}>
            ...
            <div style={{padding:'1.25rem'}}>
              {[{l:'Agent ID',v:s.agent_id},{l:'Tier',v:s.tier==='pro'?'\u{1f525} Pro (EP-verified)':'\u{1f30a} Free (Tier 3)'},{l:'Voice',v:s.access.voice_enabled?'\u2705 Enabled':'\u274c Not available (Free tier)'},{l:'Broadcast cost',v:s.access.voice_enabled?'$0.05 USDC per broadcast':'Free (text-only)'},{l:'Max tier',v:`Tier ${s.access.max_tier}`}].map(({l,v})=>(
